...
export default function ContactInfo() {
  return (
    <div className="mb-8 flex flex-col">
      <h3>Contact</h3>
      <div className="flex justify-start mt-2 text-gray-600 ml-10">
        <MapPin color="#d78b8b" />
        <a
          ...
          className="text-gray-600 hover:text-[#d78b8b] transition duration-200 ml-2"
        >
          Cabinet infirmiers
          <br />
          18 square robinson
      ...
      <div className="flex justify-start mt-2 text-gray-600 ml-10">
        ...
        <a
          href="tel:0146600974"
          className="ml-2 text-gray-600 hover:text-[#d78b8b] transition duration-200"
        >
          01.46.60.09.74
        </a>
      </div>
